...
ENTITY TPSoC IS
	PORT (
		...
		MTRR_N,MTRL_N,MTRL_P,MTRR_P : OUT STD_LOGIC;
...
COMPONENT nios_sys
	PORT (
      ...
      reset_reset_n         : in  std_logic                    := 'X';              -- reset_
		...
		pwm_motor_nr_export_export : out   std_logic;                                        -- export
		pwm_motor_nl_export_export : out   std_logic;                                        -- export
		pwm_motor_pl_export_export : out   std_logic;                                        -- export
		pwm_pr_export_export       : out   std_logic                                         -- export
);
END COMPONENT;
...
NiosII : nios_sys
	PORT MAP(
		...
		pwm_motor_nr_export_export => MTRR_N, -- pwm_motor_nr_export.export
		pwm_motor_nl_export_export => MTRL_N, -- pwm_motor_nl_export.export
		pwm_motor_pl_export_export => MTRL_P, -- pwm_motor_pl_export.export
		pwm_pr_export_export       => MTRR_P        --       pwm_pr_export.export
);
